export function About() {
  return (
    <section
      ...
      aria-label="About me"
    >
      <div className="sticky p-0 top-0 z-20 -mx-6 mb-4 w-screen bg-slate-900/75 px-6 backdrop-blur md:-mx-12 md:px-12 lg:sr-only lg:relative lg:top-auto lg:mx-auto lg:w-full lg:px-0 lg:py-0 lg:opacity-0">
